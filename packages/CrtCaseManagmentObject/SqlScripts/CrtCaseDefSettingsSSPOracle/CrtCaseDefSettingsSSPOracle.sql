...
BEGIN
	...
	WHERE "Id" = '{87B4ACF3-191A-4393-8948-3DCE970A47A7}';
	IF (cnt = 0)
		THEN
			INSERT
			INTO "SysSettingsValue" (
				"Id",
				"SysSettingsId", 
				"SysAdminUnitId",
				"IsDef",
	...
	INTO cnt
	FROM "SysSettingsValue"
	WHERE "Id" = '{DD187930-0DDC-427C-BD67-A07C6FC8979E}';
	IF (cnt = 0)
		THEN
			INSERT
			INTO "SysSettingsValue" (
	...
	INTO cnt
	FROM "SysSettingsValue"
	WHERE "Id" = '{86CDDA8F-F75B-40F6-9E9E-555F2209845E}';
	IF (cnt = 0)
		THEN
			INSERT
			INTO "SysSettingsValue" (
	...
	INTO cnt
	FROM "SysSettingsValue"
	WHERE "Id" = '{B94F241A-DA9D-46D9-907F-7B6F50B3AE2E}';
	IF (cnt = 0)
		THEN
			INSERT
			INTO "SysSettingsValue" (
	...
	INTO cnt
	FROM "SysSettingsValue"
	WHERE "Id" = '{145E60CD-8BAC-40EE-9BDE-C1017BBCD400}';
	IF (cnt = 0)
		THEN
			INSERT
			INTO "SysSettingsValue" (
	...
	INTO cnt
	FROM "SysSettingsValue"
	WHERE "Id" = '{5B3E3861-6B31-4414-996B-4296EA9EAE44}';
	IF (cnt = 0)
		THEN
			INSERT
			INTO "SysSettingsValue" (
