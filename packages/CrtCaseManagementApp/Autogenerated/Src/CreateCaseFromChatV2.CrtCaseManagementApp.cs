namespace Terrasoft.Core.Process
{
	...
	#region Class: CreateCaseFromChatV2MethodsWrapper

	/// <exclude/>
	public class CreateCaseFromChatV2MethodsWrapper : ProcessModel
	{

		public CreateCaseFromChatV2MethodsWrapper(Process process)
			: base(process) {
