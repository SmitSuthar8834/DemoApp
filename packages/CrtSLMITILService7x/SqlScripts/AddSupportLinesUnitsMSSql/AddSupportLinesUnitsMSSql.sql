IF (NOT EXISTS(SELECT NULL FROM SysAdminUnit WHERE Id = 'B5D51A2D-C0DD-477B-B2AA-58034367BA26'))
BEGIN
...
IF (NOT EXISTS(SELECT NULL FROM SysAdminUnit WHERE Id = 'BD259924-B19C-4880-8A9C-8363C67D3331'))
BEGIN
	INSERT INTO [SysAdminUnit] ([Id], [Name], [ParentRoleId], [SysAdminUnitTypeValue], [Active], [SysCultureId], [ConnectionType])
...
IF (NOT EXISTS(SELECT NULL FROM SysAdminUnit WHERE Id = '1B45C79D-F7B5-4BFC-ABE4-993F1DCF5C58'))
BEGIN
	INSERT INTO [SysAdminUnit] ([Id], [Name], [ParentRoleId], [SysAdminUnitTypeValue], [Active], [SysCultureId], [ConnectionType])
